...
contract.events.Response(() => {
  ...
  .on('data', function(event){
    ...
    console.log('New Response: ', event.returnValues.name, " ", event.returnValues.addr, " ", event.returnValues.res);
  
    //Write send email process here!
    execSync(`echo '${event.returnValues.name} has been responded to' | mail -s 'Tambora Event' bryan2j@gmail.com`, { encoding: 'utf-8' });
  })
